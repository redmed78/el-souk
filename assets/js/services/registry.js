/* =========================================================
   ...
   implementation. Today: Supabase for both 'order' and
   'analytics'. Adding a future provider means changing what's
   imported/mapped here — never the capability files, never the
   application/UI code.
========================================================= */
