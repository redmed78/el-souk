/* =========================================================
   ...
   ---------------------------------------------------------
   UPDATED IN STEP 10: `priceFilterTouched` was moved out of
   index.html into ./data.js (along with toggleFilterDrawer and
   the initPriceSlider IIFE that writes to it). It is now
   imported below as a live ES module binding — applyProductFilters()
   only ever reads it, so the live-binding import requires no
   other change here; the internal logic below is untouched.
   ---------------------------------------------------------
========================================================= */
